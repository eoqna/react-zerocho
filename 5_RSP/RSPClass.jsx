...
// Class Component의 LifeCycle
// 클래스의 경우 -> constructor -> rendering -> ref -> componentDidMount -> 
// ( setState/props바뀔 때 ) -> shouldComponentUpdate(true) -> rendering -> componentDidUpdate ->
...
class RSP extends Component {
  ...
  componentDidMount() { // 컴포넌트가 처음 렌더링된 후, 여기서 비동기 요청을 많이한다.
    this.changeHand();
  }
